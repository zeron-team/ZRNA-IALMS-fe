          ...
          <Slider {...sliderSettings}>
            <div className="feature-slide">
              <div className="feature-slide-content">
                ...
                <p>Como estudiante, tienes el poder de crear hasta dos cursos y compartirlos con la comunidad o de forma privada.</p>
              </div>
            </div>
            <div className="feature-slide">
              <div className="feature-slide-content">
                ...
                <p>Como instructor, puedes crear salas exclusivas, añadir cursos y gestionar a tus alumnos en un entorno controlado.</p>
              </div>
            </div>
            <div className="feature-slide">
              <div className="feature-slide-content">
                ...
                <p>Guía a nuestra IA con tu propio material (PDF, DOCX) para generar currículas y lecciones 100% personalizadas.</p>
              </div>
            </div>
          </Slider>
        </div>
      ...
      <section className="roles-section">
        ...
        <div className="roles-container">
          <div className="role-description">
            ...
            <p>Toma el control total de la enseñanza. Crea salas, diseña cursos con la ayuda de la IA e invita a tus alumnos a un espacio de aprendizaje único.</p>
            <ul>
          ...
          <div className="role-image">
             <img src="https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=2070" alt="Instructor enseñando" />
          </div>
        </div>
        <div className="roles-container reverse">
          <div className="role-description">
            <h3>El Estudiante: Tu Aventura de Conocimiento</h3>
            <p>Aprende a tu propio ritmo, sigue rutas de aprendizaje inteligentes o desata tu creatividad y construye tus propios cursos para compartir con el mundo.</p>
            <ul>
          ...
          <div className="role-image">
             <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070" alt="Estudiantes aprendiendo" />
          </div>
        </div>
      </section>
