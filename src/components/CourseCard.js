...
const CourseCard = ({ course, children, showEnterButton = false, progress = null, isLandingPageCard = false }) => {
  ...
  return (
    <Card className="course-card" onClick={handleCardClick} sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      {isLandingPageCard && <RatingComponent entityId={course.id} entityType="course" centerAlign={true} />}
